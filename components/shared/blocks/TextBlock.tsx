...
export function TextBlock({ content }) {
  ...
  return (
    ...
    >
      <span className="col-span-1 lg:col-span-2 translate-y-[2px] text-[12px] leading-[14px] md:text-[16px] md:leading-[18px] lg:text-[16px] lg:leading-[18px] xl:text-[16px] xl:leading-[18px] normalText    ">
        {headline}
      </span>
