  ...
  return (
    ...
    >
      <div className="lg:col-span-4 lg:grid lg:grid-cols-4">
        ...
        <div className="col-span-4 flex flex-col justify-end mt-5 lg:mt-0">
      ...
      <AnimatePresence>
        {overlayTab && isOverlayVisible && (
          ...
          >
            <div
              className="px-5 lg:px-10 my-20 flex justify-end"
              onClick={handleToggleOverlay}
            >
              <CloseIcon size={36} className="cursor-pointer" />
            </div>
            <div className="textSection grid grid-cols-1 pb-0 lg:grid-cols-8 gap-x-8 px-5 lg:px-10">
            ...
            <div className="grid grid-cols-1 items-end pb-0 lg:grid-cols-8 gap-x-8 px-5 lg:px-10 mt-5 lg:mt-0">
              <div className="col-span-4">
                <div className="grid grid-cols-4">
                  <span className="col-span-2">Locations</span>
                  {overlayTab.locations && overlayTab.locations.length > 0 && (
                    <ul className="locations-list col-span-2">
                      {overlayTab.locations.map((location) => (
                        <li
                          key={location._key}
              ...
              <div className="col-span-4 w-[80%] mx-auto mt-5 lg:mt-0">
