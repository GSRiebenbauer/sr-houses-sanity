  ...
  return (
    ...
    >
      <div className="lg:grid lg:grid-cols-8">
        ...
        <div className="lg:col-span-4 flex flex-col justify-between">
          <div>
            {/* Main Headline */}
            {headline && (
              <h2 className="headline text-6xl leading-tight">{headline}</h2>
            )}
            <div className=" mb-5  lg:mt-20" onClick={handleToggleOverlay}>
              <PlusIcon size={36} />
            </div>
          </div>
      ...
      {overlayTab && isOverlayVisible && (
        ...
        >
          <div className="flex justify-start my-20 p-5 lg:px-10">
